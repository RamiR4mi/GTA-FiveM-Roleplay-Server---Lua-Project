...
local blipcamarones = AddBlipForCoord(Config.camarones.x, Config.camarones.y, Config.camarones.z)
			...
			SetBlipScale  (blipcamarones, 1.0)
...
local making = true
	...
	TriggerEvent('esx:showNotification', '~g~Starting ~w~the production ~g~de crabs')
	Citizen.Wait(5000)
...
local makingcamarones = true
	...
	TriggerEvent('esx:showNotification', '~g~Starting ~w~the production ~g~de shrimps')
	Citizen.Wait(5000)
...
SetBlipScale(Blipventacamaronesycangrejos, 1.0)
...
local elements ={  
{ label = 'Sale Box Of Shrimp <span style = "color:#65D754;">' ..Config.PCamaron ..  '$</span>', value = 'Camarones1'},

{ label = 'Sale Box Of Crab <span style = "color:#65D754;">' ..Config.PCangrejo ..  '$</span>', value = 'Cangrejos1'},

{ label = '<span style = "color:#DA2020;">Close the window</span>', value = 'salir'},
