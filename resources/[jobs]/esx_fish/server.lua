...
ESX.RegisterUsableItem('turtlebait', function(source)
	...
	if xPlayer.getInventoryItem('fishingrod').count > 0 then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'You attach the turtle bait onto your fishing rod', length = 2500, style = { ['background-color'] = '#66ff33', ['color'] = '#ffffff' } })
	else
		TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'You dont have a fishing rod', length = 2500, style = { ['background-color'] = 'ff0000', ['color'] = '#ffffff' } })
	end
...
ESX.RegisterUsableItem('fishbait', function(source)
	...
	if xPlayer.getInventoryItem('fishingrod').count > 0 then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'You attach the fish bait onto your fishing rod', length = 2500, style = { ['background-color'] = '#66ff33', ['color'] = '#ffffff' } })		
	else
	    TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'You dont have a fishing rod', length = 2500, style = { ['background-color'] = 'ff0000', ['color'] = '#ffffff' } })
		TriggerClientEvent('fishing:message', _source, "~r~")
	end
...
ESX.RegisterUsableItem('turtle', function(source)
	...
	if xPlayer.getInventoryItem('fishingrod').count > 0 then
		...
		TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'You attach the turtle meat onto the fishing rod', length = 2500, style = { ['background-color'] = '#66ff33', ['color'] = '#ffffff' } })
	else
		TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'You dont have a fishing rod', length = 2500, style = { ['background-color'] = 'ff0000', ['color'] = '#ffffff' } })
	end
...
AddEventHandler('fishing:catch', function(bait)
	...
	if bait == "turtle" then
		...
		if bait == "none" then
			...
			if rnd >= 70 then
			TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'You are currently fishing without any equipped bait', length = 2500, style = { ['background-color'] = 'ff0000', ['color'] = '#ffffff' } })
				if  xPlayer.getInventoryItem('fish').count > 100 then
						TriggerClientEvent('fishing:message', _source, "~r~You cant hold more fish")
					else
	...
	local xPlayer  = ESX.GetPlayerFromId(_source)
			...
			if item == "turtle" then
				...
				if FishQuantity <= 0 then
				    TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'You dont have enough turtles', length = 2500, style = { ['background-color'] = 'ff0000', ['color'] = '#ffffff' } })		
				else   
					xPlayer.removeInventoryItem('turtle', 1)
			...
			if item == "shark" then
				...
				if FishQuantity <= 0 then
				    TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'inform', text = 'You dont have enough sharks', length = 2500, style = { ['background-color'] = 'ff0000', ['color'] = '#ffffff' } })			
				else   
