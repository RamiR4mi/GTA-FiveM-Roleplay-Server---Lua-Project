...
Config.EnableSocietyOwnedVehicles = ture
...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = -216.12, y = -1319.17, z = 29.89 },
	...
	Craft = {
		Pos   = { x = -199.95, y = -1315.32, z = 30.09 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -186.51, y = -1293.43, z = 31.3 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = { x = -186.51, y = -1293.43, z = 30.3 },
