...
--
	...
	},
    {
		...
		objCoords  = {x = 2555.4, y = 4651.7, z = 34.08},
		textCoords = {x = -112.8419, y = 4651.7, z = 34.08},
		authorizedJobs = { 'mafia' },
		locked = true,
		distance = 4.5,
		size = 0.7
    ...
    {
		objName = 'v_ilev_tort_door',
		objCoords  = {x = 2566.17, y = 4651.71, z = 34.08},
		textCoords = {x = 2566.17, y = 4651.71, z = 34.08},
		authorizedJobs = { 'mafia' },
		locked = true,
		distance = 4.5,
		size = 0.7
...
--	},
    {
		...
		objCoords  = {x = -1504.35, y = 111.11, z = 55.67},
		textCoords = {x = -1504.35, y = 111.11, z = 55.67},
		authorizedJobs = { 'mafia' },
		locked = true,
		distance = 1.2,
		size = 2.0
    ...
    {
		objName = 'v_ilev_ra_door4r',
		objCoords  = {x = -1506.71, y = 118.32, z = 55.67},
		textCoords = {x = -1506.71, y = 118.32, z = 55.67},
		authorizedJobs = { 'mafia' },
		locked = true,
		distance = 4.5,
		size = 3.0
    ...
    {
		objName = 'v_ilev_ra_door4r',
		objCoords  = {x = -1507.14, y = 118.56, z = 55.67},
		textCoords = {x = -1507.14, y = 118.56, z = 55.67},
		authorizedJobs = { 'mafia' },
		locked = true,
		distance = 4.0,
		size = 3.0
    ...
    {
		objName = 'v_ilev_ra_door4r',
		objCoords  = {x = -1534.35, y = 142.57, z = 55.97},
		textCoords = {x = -1534.35, y = 142.57, z = 55.97},
		authorizedJobs = { 'mafia' },
		locked = true,
		distance = 4.5,
		size = 3.8
    ...
    {
		objName = 'v_ilev_ra_door4r',
		objCoords  = {x = -1535.16, y = 141.84, z = 55.97},
		textCoords = {x = -1535.16, y = 141.84, z = 55.97},
		authorizedJobs = { 'mafia' },
		locked = true,
		distance = 4.5,
		size = 3.8
    ...
    {
		objName = 'v_ilev_mm_fridge_l',
		objCoords  = {x = -1526.35, y = 118.44, z = 55.67},
		textCoords = {x =-1526.35, y = 118.44, z = 55.67},
		authorizedJobs = { 'mafia' },
		locked = true,
		distance = 4.5,
		size = 1.2
    ...
    {
		objName = 'v_ilev_mm_fridge_r',
		objCoords  = {x = -1526.64, y = 119.28, z = 55.67},
		textCoords = {x = -1526.64, y = 119.28, z = 55.67},
		authorizedJobs = { 'mafia' },
		locked = true,
		distance = 4.5,
		size = 1.2
    ...
    {
		objName = 'v_ilev_mm_doorm_l.jpg',
		objCoords  = {x = -817.12, y = 178.51, z = 72.23},
		textCoords = {x = 0.0, y = 0.0, z = -1000.0},
		authorizedJobs = { 'killerz' },
		locked = true,
		distance = 4.5,
		size = 1.2
	},
    {
		objName = 'v_ilev_mm_doorm_r.jpg',
		objCoords  = {x = -843.23, y = 159.16, z = 66.88},
		textCoords = {x = -843.23, y = 159.16, z = 66.88},
		authorizedJobs = { 'killerz' },
		locked = true,
		distance = 4.5,
		size = 1.2
