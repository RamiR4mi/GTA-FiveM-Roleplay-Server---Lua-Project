Config = {
    ...
    Items = {
        ...
        ["readymeal"] = {
            {label = "Bread", item = "bread", price = 10},
        },
        ["diverse"] = {
             {label = "Drill", item = "drill", price = 8000},
 		{label = "Phone", item = "phone", price = 500},
        ...
        --     {label = "Net Cracker", item = "net_cracker", price = 10000},
           --  {label = "Thermite", item = "thermite", price = 5000},
          --   {label = "Pendrive", item = "pendrive", price = 45000},


	--	     {label = "Oxygen Mask", item = "oxygen_mask", price = 5000},

		--	 {label = "Weapon Clip", item = "clip", price = 600},

             {label = "Turtlebait", item = "turtlebait", price = 1000},
             {label = "Fishbait", item = "fishbait", price = 1000},
             {label = "Fishingrod", item = "fishingrod", price = 1000},
