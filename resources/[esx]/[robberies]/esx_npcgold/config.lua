...
Config.ItemMinAmount1 = 30 				-- set minimum reward amount of item1 (this value is multiplied with x100)
Config.ItemMaxAmount1 = 40				-- set maximum reward amount of item1 (this value is multiplied with x100)
...
Config.ItemMinAmount2 = 6					-- set minimum reward amount of item2
Config.ItemMaxAmount2 = 9					-- set maximum reward amount of item2
