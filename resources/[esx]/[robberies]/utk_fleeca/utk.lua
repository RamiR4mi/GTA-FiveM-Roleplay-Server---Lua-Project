...
UTK.maxcash = 350 -- maximum amount of cash a pile can hold
UTK.mincash = 650 -- minimum amount of cash a pile holds
UTK.black = true -- enable this if you want blackmoney as a reward
UTK.cooldown = 26400 -- amount of time to do the heist again in seconds (600 = 15min)
