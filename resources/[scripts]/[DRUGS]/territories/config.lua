...
Config = {
  ...
  InfluenceTick     = 3000,           -- how long between influence gain/loss tick?
...
Territories = {
  ["East V"] = {
    ...
    influence = 10.0,                                    -- The default influence for this zone.
    ...
    areas = {                                             -- Areas are responsible for the large square blips on the map.
      [1] = { 
        location  = vector3(1005.81,-114.77,73.97),
        width     = 350.0,
        height    = 200.0,
        heading   = 60,
        display   = 3
    ...
    blipData = {                                          -- BlipData is responsible for the blip corresponding to the entry action of this zone.
      pos = vector3(1005.81,-114.77,73.97),
      sprite = 500,
      color = 1,
    ...
    actions = { 
      ...
      ["gather_money"] = {
        ...
        time        = 15000,                              -- Action bar timer. Probably don't change these unless you find they're set incorrect.
  ...
  ["Galilee"] = {
    ...
    areas = {
      [1] = {
        location  = vector3(1334.48,4306.8,38.23),
        width     = 390.0,
        height    = 210.0,
        heading   = 100,
        display   = 3
    ...
    blipData = {
      pos = vector3(1334.48,4306.8,38.23),
      sprite = 496,
      color = 2,
  ...
  ["Stab City"] = {
    ...
    areas = {
      [1] = {
        location  = vector3(68.07,3693.21,40.64),
        width     = 200.0,
        height    = 280.0,
        heading   = 50,
        display   = 3
    ...
    blipData = {
      pos = vector3(68.07,3693.21,40.64),
      sprite = 499,
      color = 3,
  ...
  ["Palmer-Taylor Power Station"] = {
    ...
    areas = {
      [1] = {
        location  = vector3(2793.28,1476.42,24.56),
        width     = 290.0,
        height    = 220.0,
        heading   = 0,
        display   = 3
    ...
    blipData = {
      pos = vector3(2842.81,1456.99,24.74),
      sprite = 497,
      color = 0,
    ...
    actions = {
      ["entry"] = {
        ...
        location = vector3(2842.81,1456.99,24.74),
      },
      ["exit"] = {
