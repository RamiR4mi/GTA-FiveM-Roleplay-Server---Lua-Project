radioConfig = {
    ...
    Frequency = {
        Private = { -- List of private frequencies
            [600] = true, -- Make 1 a private frequency
            [601] = true, -- Make 1 a private frequency
            [602] = true, -- Make 1 a private frequency
            [603] = true, -- Make 1 a private frequency
            [604] = true, -- Make 1 a private frequency
            [605] = true, -- Make 1 a private frequency
