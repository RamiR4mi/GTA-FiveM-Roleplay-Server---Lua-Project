...
$("#deposit100").click(function(){
  $.post('https://banking/Deposit100', JSON.stringify({}));
})

$("#deposit1000").click(function(){
  $.post('https://banking/Deposit1000', JSON.stringify({}));
})

$("#deposit10000").click(function(){
  $.post('https://banking/Deposit10000', JSON.stringify({}));
})

$("#withdraw100").click(function(){
  $.post('https://banking/Withdraw100', JSON.stringify({}));
})

$("#withdraw1000").click(function(){
  $.post('https://banking/Withdraw1000', JSON.stringify({}));
})

$("#withdraw10000").click(function(){
  $.post('https://banking/Withdraw10000', JSON.stringify({}));
})
...
$("#deleteSavings").click(function(){
  $.post('https://banking/deleteSavingsAccount', JSON.stringify({}));
})
...
$("#savingsDepositButton").click(function(){
  ...
  if(amount !== undefined && amount > 0) {
    $.post('http://banking/savingsDeposit', JSON.stringify({ 
      amount: parseInt(amount)
    }));
...
$("#savingsWithdrawButton").click(function(){
  ...
  if(amount !== undefined && amount > 0) {
    $.post('http://banking/savingsWithdraw', JSON.stringify({ 
      amount: parseInt(amount)
    }));
...
$("#transferButton").click(function(){
  ...
  if(identifier !== undefined && identifier > 0) {
    if(amount !== undefined && amount > 0) {
      $.post('http://banking/transferMoney', JSON.stringify({ 
...
$("#orderNewCardButton").click(function(){
  $.post('http://banking/orderNewCard', JSON.stringify({}));
})
...
$("#comfirmChangePinButton").click(function(){
  ...
  if(pin !== undefined && pinlength == 4) {
    $.post('http://banking/createPin', JSON.stringify({ 
      pin: pin
    }));
    $("#changePin").css({"display":"none"});
